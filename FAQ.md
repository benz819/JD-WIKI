...
3. 日志能产生但一直是空的，两个解决办法：
    ...
    请搞明白PATH的含义：[一文精通crontab](https://zhuanlan.zhihu.com/p/58719487)，重点阅读这一篇文章的“环境变量问题”这一章节，出现日志能产生但一直是空的这个问题绝对是PATH有问题导致的，请将这篇文件理解透后，再来更改你的PATH。注意：PATH中，前面的路径比后面的路径优先级更高。